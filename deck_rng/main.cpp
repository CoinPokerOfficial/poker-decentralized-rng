...
EXPORT
DecentralizedRNGDeck::IDeckRNG* CreateDeckRNG()
{
    return new DecentralizedRNGDeck::HandRNG();
}

EXPORT
void DestroyDeckRNG(DecentralizedRNGDeck::IDeckRNG* rng)
{
    delete rng;
}
